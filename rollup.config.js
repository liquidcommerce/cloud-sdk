...
const commonPlugins = [
  replace({
    ...
    values: {
      ...
      'process.env.ENV_LOC': JSON.stringify(process.env.ENV_LOC || 'http://localhost:8000'),
      'process.env.ENV_DEV': JSON.stringify(process.env.ENV_DEV || 'https://dev.api.liquidcommerce.cloud'),
      'process.env.ENV_STAGE': JSON.stringify(process.env.ENV_STAGE || 'https://staging.api.liquidcommerce.cloud'),
      'process.env.ENV_PROD': JSON.stringify(process.env.ENV_PROD || 'https://api.liquidcommerce.cloud'),
      'process.env.ENV_BETA': JSON.stringify(process.env.ENV_BETA || ''),
