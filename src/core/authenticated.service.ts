...
export class AuthenticatedService {
  ...
  private readonly demoSessionToken?: string;
  ...
  public constructor(config: IAuthConfig) {
    ...
    this.demoSessionToken = config.demoSessionToken;
    this.env = config.env;
  ...
  public getUniqueKey(): string {
    return JSON.stringify([this.apiKey, this.baseURL, this.demoSessionToken ?? null]);
  }
  ...
  private async requestWithoutAuth<T>(path: string, options: IRequestOptions): Promise<T> {
    ...
    const headers: Record<string, string> = {
      ...
      ...options.headers,
      ...(this.demoSessionToken ? { 'X-LIQUID-DEMO-SESSION': this.demoSessionToken } : {}),
    };
