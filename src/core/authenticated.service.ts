...
export class AuthenticatedService {
  ...
  private readonly accelpayDemo?: { partnerAppToken: string; cartScopeId: string };
  ...
  public constructor(config: IAuthConfig) {
    ...
    this.accelpayDemo = config.accelpayDemo;
    this.env = config.env;
  ...
  public getUniqueKey(): string {
    return JSON.stringify([this.apiKey, this.baseURL, this.accelpayDemo ?? null]);
  }
  ...
  private async requestWithoutAuth<T>(path: string, options: IRequestOptions): Promise<T> {
    ...
    const headers: Record<string, string> = {
      ...
      ...(this.accelpayDemo
        ? {
            'X-LIQUID-PARTNER-APP-TOKEN': this.accelpayDemo.partnerAppToken,
            'X-LIQUID-DEMO-CART-ID': this.accelpayDemo.cartScopeId,
          }
        : {}),
    };
