...
if (typeof window !== 'undefined') {
  ...
  (window as any).PaymentLiquidCommerce = PaymentLiquidCommerce;
  (window as any).LIQUID_COMMERCE_ENV = LIQUID_COMMERCE_ENV;
}

export { LIQUID_COMMERCE_ENV, LiquidCommerce, OrderLiquidCommerce, PaymentLiquidCommerce };
