...
class LiquidCommerceClient implements ILiquidCommerceClient {
   ...
   * @property {function(params: IUserPaymentUpdateParams): Promise<IApiResponseWithData<IUserPayment>>} updatePayment -
  ...
  public user: IUserMethod = {
    ...
    updatePayment: async (params: IUserPaymentUpdateParams): Promise<IApiResponseWithData<IUserPayment>> => {
      await this.ensureAuthenticated();
